...
if __name__ == "__main__":
    simcnt = 150 #The number of simulation runs, set it to 3 during development otherwise you will wait for a long time
    ...
    resultfile.write("NodeCount,PathLength,CompileTime,KeyGenerationTime,EncryptionTime,ExecutionTime,DecryptionTime,ReferenceExecutionTime,Mse\n")
    resultfile.close()
    
    print("Simulation campaing started:")
    for nc in range(30,100,10): # Node counts for experimenting various graph sizes
        n = nc
